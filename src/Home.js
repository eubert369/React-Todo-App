        ...
        return (
            <>
                ...
                <div className="row px-5">
                    <CreateTodo btnState={createBtnState} setItems={setTodo} getItems={getTodo} fetch={fetchData} />
                </div>
            </>
        );
        ...
        return (
            <>
                ...
                <div className="row px-5 mt-5">
                    ...
                    <DoneTodo finished={getDone} setFinished={setDone} searched={search} />
...
function Search(props) {
    return (
        <div className="input-group w-10 mb-3">
            <input type="text" className="form-control" placeholder="Search ..." onChange={props.searchType} />
            <label className="btn btn-primary" onClick={props.handleClick} ><img src={search_icon} className="img" alt="search icon" width={30} /> </label>
        </div>
    );
}
